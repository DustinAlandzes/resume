...
\begin{document}
   ...
   \begin{itemize}
     ...
     \item[] Member of the clinical team that took ownership of the clinical notes and prescription ordering components.
     ...
     \item[] Took ownership of the laboratory functionality, responded to incidents, and had meetings with Quest and LabCorp.
   ...
   \textbf{\href{https://bootcamp.utsa.edu/coding/}{UTSA Coding Bootcamp} (San Antonio)} \hfill {January 2020 to June 2020}
    \begin{itemize}
     ...
     \item[] Helped student learning JavaScript, Node.js and React at the UTSA campus 2 days a week.
    ...
    \begin{itemize}
     ...
     \item[] Integrated with the 2Captcha API to solve captchas.
    \end{itemize}
